<?php
namespace Xuandai\HelloWorld\Observer; 
...
class ProductdataObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $stockData = $productStockObj['qty'];
        $stockStatus = $productStockObj['is_in_stock'];

        // die(print_r($productStockObj->getData()));
